  ...
  return (
    <button
      className={cn(
        ...
        {
          'bg-black text-white hover:bg-black/90 after:absolute after:inset-0 after:rounded-md after:border after:border-black/40 after:content-[""] after:opacity-0 hover:after:opacity-100 after:transition-opacity': variant === 'primary',
